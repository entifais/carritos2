...
public class Principal{
    ...
    public void mostrarMenu(){
        ...
        while(menuAbierto){
            ...
            }else if(elecion.equals("7old")||elecion.toLowerCase().equals("mostrar informacion de todos los sensores")||elecion.toLowerCase().equals("todos los sensores")){
